...
if( !class_exists('acf_sidebar') ) :


class acf_sidebar extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Sidebar', 'acf-sidebar');
	...
	*/
    ...
    <select name="<?php echo esc_attr( $field['name'] ); ?>">
      <?php foreach( $wp_registered_sidebars as $sidebar ): ?>
        <option value="<?php echo $sidebar['id']; ?>"<?php echo $field['value'] == $sidebar['id'] ? ' selected' : ''; ?>><?php echo $sidebar['name']; ?></option>
      <?php endforeach; ?>
    </select>
    <?php
	...
	*/
    ...
    // register & include JS
		wp_register_script( 'acf-input-sidebar', "{$url}assets/js/sidebar.js", array('acf-input'), $version );
		wp_enqueue_script('acf-input-sidebar');


		// register & include CSS
		wp_register_style( 'acf-input-sidebar', "{$url}assets/css/sidebar.css", array('acf-input'), $version );
		wp_enqueue_style('acf-input-sidebar');
